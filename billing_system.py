...
global conn, cursor
conn= connector.connect(host="localhost",database="pos",user="root",password="project_12")
cursor = conn.cursor()
...
def billing():
    ...
    clear()
    print('                                 Antique Aramane                            ')
    print('                         Vasanth Nagar, Bengaluru, Karnataka                     ')
    print('                Phone: 9478342734, Email: antiquearamane@gmail.com                    ')
